...
export const ACTION_POST_CAMPUS_DRIVE_INDUCTION_INFO_REQUEST = '@ACTION/POST/CAMPUS-DRIVE-INDUCTION-INFO/REQUEST';
export const ACTION_PATCH_CAMPUS_DRIVE_INDUCTION_INFO_REQUEST = '@ACTION/PATCH/CAMPUS-DRIVE-INDUCTION-INFO/REQUEST';
export const ACTION_DELETE_CAMPUS_DRIVE_INDUCTION_INFO_REQUEST = '@ACTION/DELETE/CAMPUS-DRIVE-INDUCTION-INFO/REQUEST';
export const ACTION_POST_CAMPUS_DRIVE_INTERVIEW_ROUNDS_REQUEST = '@ACTION/POST/CAMPUS-DRIVE-INTERVIEW-ROUNDS/REQUEST';
export const ACTION_PATCH_CAMPUS_DRIVE_INTERVIEW_ROUNDS_REQUEST = '@ACTION/PATCH/CAMPUS-DRIVE-INTERVIEW-ROUNDS/REQUEST';
export const ACTION_SHARE_CAMPUS_DRIVE_INTERVIEW_ROUNDS_REQUEST = '@ACTION/SHARE/CAMPUS-DRIVE-INTERVIEW-ROUNDS/REQUEST';
export const ACTION_GET_CAMPUS_DRIVE_EMAIL_TEMPLATE_DETAILS_REQUEST = '@ACTION/GET/CAMPUS-DRIVE-EMAIL-TEMPLATE-DETAILS/REQUEST';
export const ACTION_PATCH_CAMPUS_DRIVE_EMAIL_TEMPLATE_INFO_REQUEST = '@ACTION/PATCH/CAMPUS-DRIVE-EMAIL-TEMPLATE-DETAIlS/REQUEST';
export const ACTION_DELETE_CAMPUS_DRIVE_EMAIL_TEMPLATE_INFO_REQUEST = '@ACTION/DELETE/CAMPUS-DRIVE-EMAIL-TEMPLATE-INFO/REQUEST';
...
export const ACTION_POST_CAMPUS_DRIVE_INTERVIEW_STUDENTS_LIST_REQUEST = '@ACTION/POST/CAMPUS-DRIVE-INTERVIEW-STUDENTs-LIST/REQUEST';
